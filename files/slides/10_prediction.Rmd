...
knitr::include_graphics("../../files/images/pets/two_cats.jpg")
```
...
As our model gets more flexible, the training error decreases and the test error increases. 

Which do we care about more? The training error? The test error?
...
We would like to balance bias and variance in order to get the smallest test error. 
...
knitr::include_graphics("../../files/images/pets/andys_dog.jpeg")
```
