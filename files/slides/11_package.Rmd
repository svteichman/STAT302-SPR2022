---
title: "STAT 302, Lecture Slides 11"
...
5. Navigate through your files to find the folder with the same name as your package. Inside that folder, click on the `.Rproj` file. That will open your package in a new R project.
...
To use `GPL-3` run the following in your console: 
...
Run `usethis::use_vignette("tutorial", title = "PACKAGE_NAME Tutorial")` in your console, changing the package name to match. This will:
...
Add your own name to the YAML header using the `author:` field.
...
```{r, echo = FALSE, out.width = "350px", fig.align = "center"}
knitr::include_graphics("../../files/images/pets/Indy.jpeg")
```
