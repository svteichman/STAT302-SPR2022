...
knitr::include_graphics("../../files/images/pets/chunI_cat.jpeg")
```
...
--
  ...
  * Type I: $P(\text{reject } H_0 | H_0 \text{ true})$
  * Type II: $P(\text{fail to reject } H_0 | H_0 \text{ false})$
...
knitr::include_graphics("../../files/images/pets/hunter.jpeg")
```
...
What do our test statistics and p-values represent? 

--

For each coefficient, we test the null hypothesis: $H_0: \beta_j = 0$

--

For the non-intercept coefficients, this hypothesis represents no linear relationship between predictor $j$ and the outcome $Y$
